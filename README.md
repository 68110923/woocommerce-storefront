# E-commerce Independent Site Frontend — WooCommerce / WordPress
...
> 面向海外市场的 **WooCommerce / WordPress 电商独立站前端设计系统**。一套可复用的店面前端设计,风格简约、大气、高级感。基于 **Astra 主题 + WooCommerce**,通过一个 **mu-plugin(站点插件)** 注入整套自定设计系统,不动主题源码,便于升级维护。
